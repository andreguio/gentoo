...
####
#echo 'USE="X -wayland -systemd elogind xfce -gnome -kde gtk3 -qt4 -motif -dvd -ipod alsa -oss pulseaudio -pipewire mesa opengl vulkan -nvidia -intel"' >> /etc/portage/make.conf
