...
#echo 'USE="-a52 -bluebooth -cdda -cdr -cups -dvd -dvdr -ppds -qt5 -spell mesa vaapi vdpau pulseaudio xfce -systemd -accessibility -cuda -nvenc -wayland -nvidia -gnome -kde -plasma -handbook -scanner -ipod -motif -wifi -qt6 -pipewire -oss"' >> /etc/portage/make.conf
####
#### ==========================	11 - REPOSITÓRIO
####
